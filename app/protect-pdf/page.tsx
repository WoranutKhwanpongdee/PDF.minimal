...
import { FileUp, File as FileIcon, Trash2, ArrowLeft, Loader2, Download, Lock } from "lucide-react";
...
export default function ProtectPdfPage() {
  ...
  const [protectedFile, setProtectedFile] = useState<{ url: string; name: string } | null>(null);
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 p-8 font-sans">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-500 mb-8">Add a password to your PDF document securely on your device.</p>
        ...
        {!file ? (
          <div className="border-2 border-dashed border-gray-200 rounded-lg p-12 text-center hover:bg-gray-50 transition-colors relative mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1">Upload a PDF file to protect</p>
          </div>
        ) : (
          <div className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-md border border-gray-100 mb-8">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Password to protect the PDF"
                ...
                <p className="mt-2 text-xs text-gray-500">
                  This password will be required to open the document. Make sure to remember it.
                </p>
              </div>
            )}
            ...
            {protectedFile && (
              <div className="mt-6 p-6 border border-green-100 bg-green-50 rounded-md">
                <h3 className="text-green-800 font-semibold mb-4 text-center">PDF Protected Successfully!</h3>
                <a
